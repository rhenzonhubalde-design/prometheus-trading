"""
Prometheus Phase 2 — Master Research Orchestrator
Runs all 4 research scripts in sequence and generates trade theses.
Scheduled by Hermes cron every weekday at 9:00pm SGT (US market open).
"""
import sys
import os
...
def run_all():
    ...
    print(f"  Results → ~/prometheus/phase2/data/trade_theses.json")
    print(f"{'=' * 60}\n")
